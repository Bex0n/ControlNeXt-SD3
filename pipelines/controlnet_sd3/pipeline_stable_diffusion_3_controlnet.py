...
# <<< CONTROLNEXT changed pipeline name >>>
class StableDiffusion3ControlNeXtPipeline(
    ...
    def __init__(
        ...
        tokenizer_3: T5TokenizerFast,
        controlnet: Union[
            SD3ControlNeXtEncoder, List[SD3ControlNeXtEncoder], Tuple[SD3ControlNeXtEncoder]
        ],
    ...
    def __call__(
        ...
        controlnet_conditioning_scale: Union[float, List[float]] = 1.0, # <<< CONTROLNEXT: This now acts as `controlnext_scale` >>>
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                controlnext_embedding = self.controlnet(
                ...
                noise_pred = self.transformer(
                    ...
                    controlnext_scale=controlnet_conditioning_scale,
